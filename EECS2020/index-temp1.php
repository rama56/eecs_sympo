		...
		We confirm the registration of all those who have submitted the registration form. <br> <a class="btn btn-danger mt-3" href="note-to-registrants.html">View Details</a>
          ...
          <div class="row text-left text-white align-items-start mt-5">
            <div class="col-12 col-md-6 col-lg-4">
              <h3>July 10 <a class="btn btn-danger" href="https://airmeet.com/e/ae4db900-c138-11ea-ae9b-8d6125d4f5a7" style="float:right;">Join Event Live</a></h3>
            ...
            <div class="col-12 col-md-6 col-lg-4 pt-4 pt-md-0">
              <h3>July 11 <a class="btn btn-danger" href="https://www.airmeet.com/e/28c62ef0-c068-11ea-9f77-41c559c18ad8" style="float:right;">Join Event Live</a></h3>
              <hr style="height: 1px;background-color: #ccc;border: none;">
            ...
            <div class="col-12 col-md-8 m-auto m-lg-0 col-lg-4 pt-5 pt-lg-0">
              <h3>July 12 <a class="btn btn-secondary" href="javascript:void()" style="float:right;">Event Link will be updated here</a></h3>
              <hr style="height: 1px;background-color: #ccc;border: none;">
